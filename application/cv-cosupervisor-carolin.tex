...
\begin{document}
\pagemark{CV Carolin Reichherzer -- start}
\lengthnote{max 2 pages per person (per the call)}

\begin{center}
{\Large\bfseries Carolin Reichherzer}\par\vspace{2pt}
[Title, e.g. Associate Professor]\par
% Title/affiliation not yet confirmed with Carolin directly -- see
% AGENTS.md's "Team" section. Do not guess; fill in once confirmed.
[Department, CEBE partner university]
\end{center}
...
\vspace{0.3cm}
% Known profile page (not ORCID/Scopus): https://www.carolinreichherzer.com/
...
\pagemark{CV Carolin Reichherzer -- end}
\end{document}
