...
\begin{document}
\pagemark{CV Jhonattan G T Martinez Ribon -- start}
\lengthnote{max 2 pages per person (per the call)}

\begin{center}
{\Large\bfseries Jhonattan G T Martinez Ribon}\par\vspace{2pt}
Assistant Professor\par
Dept. of Civil and Architectural Engineering (Design and Construction group), Aarhus University
\end{center}
...
\vspace{0.3cm}
% Known profile page (not ORCID/Scopus): https://pure.au.dk/portal/en/persons/jgmartinez%40cae.au.dk
...
\pagemark{CV Jhonattan G T Martinez Ribon -- end}
\end{document}
